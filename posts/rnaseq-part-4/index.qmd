...
For example, you want to check if your condition of interest leads to statistically significant differences in gene expression compared to the control. The design matrix for this would simply be
`~ condition`.\
...
```{r}
#| label: volcano-plot
#| fig-cap: "Volcano plot of differentially expressed genes between type I diabetes and healthy subjects"
#| fig-width: 8
#| fig-height: 8
#| out-width: 100%
#| out-height: 100%
